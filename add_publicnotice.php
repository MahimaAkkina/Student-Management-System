            ...
            <div class="col-sm-7 col-md-7 col-lg-9 mt-4 mx-5 bg-light rounded-4">
                ...
                <div class="row">
                    <div class="col-12 d-flex justify-content-center">
                        <form method="post" class="p-3 w-50 bg-secondary fw-bold text-white border mt-5 border-2 border-primary rounded-4" enctype="multipart/form-data">
                            <h4 class="text-center my-3">Add Public Notice</h4>
                            <div class="mb-3">
...
$conn=mysqli_connect("localhost","root","","studentproject");
  if(isset($_POST['submit'])){
    $nt=$_POST['notitle'];
    $nm=$_POST['nomsg'];
    $sql="INSERT INTO `publicnotice`(`NoticeTitle`,`NoticeMessage`) VALUES ('$nt','$nm')";
