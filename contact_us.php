...
if(isset($_POST['update'])){
    ...
    $updt="UPDATE `page` SET `PageTitle`=' $pgtitle',`PageDescription`='$pgdes' WHERE  PageType='contact us'";
    ...
    $read="select * from page where PageType='contact us' ";
                ...
                <div class="row">
                    <div class="col-12">
                        <form method="post" class="m-3 p-3 bg-secondary fw-bold text-white border border-2 border-primary rounded-4" enctype="multipart/form-data">
                            ...
                            <h4 class="text-center my-3">Update Contact Us</h4>
                            <div class="mb-3">
