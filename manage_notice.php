        ...
        <div class="row">
            ...
            <div class="d-flex mx-5 justify-content-between my-4">
                ...
                <div class="table-responsive bg-light px-5 py-3 rounded-3">
                    <p class="h4 text-start mt-3 mb-4">Manage Notice</p>
                    <table class="table table-bordered table-striped table-hover text-center">
                        ...
                        <?php
                            ...
                            // $fetch="select * from notices where hidden=0";
                            $fetch ="select notices.SNo, NoticeTitle, ClassName, Section, notices.NoticeDate FROM classs join notices on classs.ID=notices.ClassID where notices.hidden=0";
                            if($result=mysqli_query($conn,$fetch)){
                                if(mysqli_num_rows($result) > 0){
                                    while($record=mysqli_fetch_array($result)){
                                        ...
                                        echo "<td>" .$record['NoticeDate'] ."</td>";
                                        echo "<td>";
                                        //echo '<i class="bi bi-eye-fill">';
                                        echo '<a href="view_notice.php?SNo='.$record['SNo'].'"><i class="bi bi-eye-fill"></i></a>';
                                        //echo '  &nbsp;||&nbsp;  <i class="bi bi-trash3-fill">';
                                        echo '&nbsp;||&nbsp;  <a href="delete_notice.php?SNo='.$record['SNo'].'"><i class="bi bi-trash3-fill"></i></a>';
                                        echo "</td>";
                                    }
                                }
                            }
