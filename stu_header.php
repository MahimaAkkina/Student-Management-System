                ...
                <div class="collapse navbar-collapse d-flex justify-content-end me-5" id="navbarNavDarkDropdown">             
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDarkDropdownMenuLink" style="margin-left:-70px !important; width:210px;">
                                <div class="dropdown-header text-center">
                                    ...
                                    <p class="font-weight-light text-muted mb-0"><?php echo $_SESSION['StudentEmail'];?></p>
                                </div>
                                <ul class="list-unstyled mx-4 my-2">
                                    <li><a class="dropdown-item border-bottom border-2 py-2" href="stu_my_profile.php"><i class="bi bi-person text-info me-2"></i>My Profile</a></li>
                                    <li><a class="dropdown-item border-bottom border-2 py-2" href="stu_setting_password.php"><i class="bi bi-gear text-info me-2"></i>Setting</a></li>
                                    <li><a class="dropdown-item mb-1 py-2" href="student_dashboard.php?logo='2'"><i class="bi bi-power text-info me-2"></i>Sign Out</a></li>
                                </ul>
                            </ul>
                        </li>
                    </ul>
